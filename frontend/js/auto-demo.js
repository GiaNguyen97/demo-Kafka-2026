...
async function startAutoDemo() {
  ...
  try {
    ...
    await fetch(`http://localhost:8082/users/pause`, { method: 'POST' });
    ...
    await fetch(`http://localhost:8082/users/resume`, { method: 'POST' });
